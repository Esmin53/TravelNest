        ...
        {<Carousel>
            <CarouselContent className="-ml-1 h-56 xs:h-44">
                {PropertyTypesArray.map((item, index) => {
                    return (
                        <CarouselItem className="xs:basis-1/2 md:basis-1/3 lg:basis-1/4 p-1 overflow-hidden" key={index}>
                        <div className="w-full h-full xs:rounded-md p-1 relative z-10 ">
                            ...
                            hover:scale-110 transition duration-500 cursor-pointer object-fill"/>
